...
/** Default grid: enough points for curves, few enough for one request. */
export const GRID_COLS = 24;
export const GRID_ROWS = 16;
/** Open-Meteo answered 384 in one call; this keeps a client from asking for thousands. */
export const GRID_MAX_POINTS = 480;
