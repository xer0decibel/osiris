...
| Property lines | ArcGIS window, "Property Lines" quick-pick | There is no national parcel layer, free or paid; counties publish their own. The pick searches "parcels" against the current view and imports the county's service, capped at 2,000 features a view, so use a neighbourhood zoom. Measured: King County's layer gives 703 polygons with addresses for a few downtown blocks in under a second |
