...
| Surface Temperature | `wx_temp`, `/api/weather-radar` | AIRS daily surface air temperature from GIBS, land and sea, tile zoom 6, dated 36h back because today's composite has holes at midday and yesterday's is complete at every zoom (measured tile by tile) |
